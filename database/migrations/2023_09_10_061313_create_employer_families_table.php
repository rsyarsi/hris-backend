...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('employer_families', function (Blueprint $table) {
            ...
            $table->tinyInteger('is_dead')->nullable();
            ...
            $table->foreignId('province_id')->nullable()->constrained('indonesia_provinces')->nullOnDelete();
            $table->foreignId('city_id')->nullable()->constrained('indonesia_cities')->nullOnDelete();
