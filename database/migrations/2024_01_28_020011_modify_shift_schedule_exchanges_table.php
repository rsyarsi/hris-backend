...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('shift_schedule_exchanges', function (Blueprint $table) {
            ...
            $table->foreign('to_shift_awal_id')->references('id')->on('shifts')->onDelete('set null');
            $table->string('to_shift_awal_id', 26)->nullable();
    ...
    public function down()
    {
        Schema::table('shift_schedule_exchanges', function (Blueprint $table) {
            ...
            $table->dropForeign(['to_shift_awal_id']);
            $table->dropColumn('to_shift_awal_id');
