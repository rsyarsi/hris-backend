...
class GenerateAbsenService implements GenerateAbsenServiceInterface
{
    ...
    public function update($id, $data)
    {
        ...
        $shiftScheduleIdExists = $data['shift_schedule_id'];
        $employeeId = $data['employee_id'];
        if ($shiftScheduleIdExists !== null) {
            $shiftSchedule = $this->shiftScheduleService->show($shiftScheduleIdExists);
        } else {
    ...
    public function absenFromMobile(array $data)
    {
        ...
        $leaveStatusIdNotIn = [6, 7, 8, 9, 10];
        // if (
        //     $shiftSchedule->leave &&
        //     $shiftSchedule->leave->leave_type_id == 1 &&
        //     !in_array($shiftSchedule->leave->leave_status_id, $leaveStatusIdNotIn)
        // ) {
        //     return [
